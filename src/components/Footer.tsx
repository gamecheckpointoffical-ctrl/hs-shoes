...
export default function Footer() {
  return (
    <footer className="bg-ink text-cream pt-28 pb-12 px-6 md:px-16 relative overflow-hidden">
        ...
        <div className="grid grid-cols-2 md:grid-cols-12 gap-8 md:gap-12 mb-24">
          <div className="col-span-2 md:col-span-5">
            ...
            <div className="space-y-2">
              <a href="tel:003175477734" className="flex items-center gap-3 text-sm text-cream/60 hover:text-cream transition-colors">
          ...
          <div className="md:col-span-2 md:col-start-7">
            <h4 className="text-[10px] uppercase tracking-[0.25em] mb-6 text-cream/20">Shop</h4>
            <ul className="space-y-3.5">
              <li><Link href="/shop" className="text-sm text-cream/60 hover:text-cream transition-colors">All Products</Link></li>
              <li><Link href="/shop?filter=new" className="text-sm text-cream/60 hover:text-cream transition-colors">New Arrivals</Link></li>
              <li><Link href="/shop?filter=bestseller" className="text-sm text-cream/60 hover:text-cream transition-colors">Bestsellers</Link></li>
              <li><Link href="/shop?category=boots" className="text-sm text-cream/60 hover:text-cream transition-colors">Boots</Link></li>
            </ul>
          </div>
          <div className="md:col-span-2">
            <h4 className="text-[10px] uppercase tracking-[0.25em] mb-6 text-cream/20">Company</h4>
            <ul className="space-y-3.5">
              ...
              <li><Link href="/shipping" className="text-sm text-cream/60 hover:text-cream transition-colors">Shipping</Link></li>
              <li><Link href="/returns" className="text-sm text-cream/60 hover:text-cream transition-colors">Returns</Link></li>
            </ul>
          </div>
          <div className="md:col-span-2">
            <h4 className="text-[10px] uppercase tracking-[0.25em] mb-6 text-cream/20">Legal</h4>
            <ul className="space-y-3.5">
