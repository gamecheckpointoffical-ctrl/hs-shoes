      ...
      <div className="container-lux py-12 md:py-20">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="space-y-8 text-ash text-[15px] leading-relaxed font-light">
            ...
            <div>
              <h2 className="text-cream text-base font-medium mb-3">Information We Collect</h2>
              <p>Your name, email, phone number, and shipping address — used solely for order processing and delivery.</p>
            </div>
            <div>
              <h2 className="text-cream text-base font-medium mb-3">How We Use It</h2>
            ...
            <div>
              <h2 className="text-cream text-base font-medium mb-3">Data Security</h2>
