      ...
      <div className="container-lux py-12 md:py-20">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="space-y-8 text-ash text-[15px] leading-relaxed font-light">
            ...
            <div>
              <h2 className="text-cream text-base font-medium mb-3">Orders</h2>
            ...
            <div>
              <h2 className="text-cream text-base font-medium mb-3">Payment</h2>
              <p>We currently accept Cash on Delivery within Pakistan. Additional payment methods will be available soon.</p>
            </div>
            <div>
              <h2 className="text-cream text-base font-medium mb-3">Product Information</h2>
            ...
            <div>
              <h2 className="text-cream text-base font-medium mb-3">Contact</h2>
